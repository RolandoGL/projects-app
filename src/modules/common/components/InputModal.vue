<template>
        ...
        <div class="modal-box">
            ...
            <div class="modal-action flex flex-col">
                <form method="dialog" @submit.prevent="submitValue">
                    <input v-model="inputValue" type="text" placeholder="Nombre del proyecto"
    ...
    <div class="modal-backdrop fixed top-0 left-0 z-10 bg-black opacity-30 w-screen h-screen"></div>
</template>
